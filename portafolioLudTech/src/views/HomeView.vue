            ...
            <div class="text-center text-xxl-start">
              ...
              <div class="fs-3 fw-light text-light">
                <p class="lead fw-light text-light mb-4">
                  I’m a Software Engineer currently working as a DevOps Engineer at Banco de Bogotá,
                  with 2 years of experience building and automating cloud solutions. My background
                  includes web development with PHP and Vue.js, covering requirements analysis,
                  implementation, and support, as well as process automation using Power Automate
                  and Copilot Studio. On the cloud side, I design and integrate solutions on AWS
                  using Lambda, API Gateway, RDS, VPC, and EC2, and manage infrastructure as code
                  with Terraform (IaC). I also build and maintain CI/CD pipelines with GitHub
                  Actions and contribute to an Internal Developer Platform (IDP) built with
                  Backstage to standardize and accelerate software delivery. In parallel, I’m
                  expanding my skills in AWS AI services (SageMaker and Bedrock AgentCore) and have
                  foundational knowledge of Oracle Cloud Infrastructure (OCI), always focused on
                  continuous learning and delivering impact through modern DevOps practices.
                </p>
              </div>
              <div
