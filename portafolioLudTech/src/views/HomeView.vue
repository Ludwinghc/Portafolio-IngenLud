            ...
            <div class="text-center text-xxl-start">
              ...
              <div class="fs-3 fw-light text-light">
                <p class="lead fw-light text-light mb-4">
                  I am a software engineer with one year of experience, a final semester student of Software Engineering
                  and a
                  student member of the Colombian Society of Engineers. Although my experience is limited, I am
                  passionate
                  about technology and I have a great willingness to learn new tools and methodologies to boost my
                  professional
                  growth. I stand out for my ability to work in a team, assuming leadership roles when necessary, and
                  for my
                  commitment to each project. I enjoy facing new challenges that allow me to expand my knowledge and
                  provide
                  innovative solutions.
                </p>
              </div>
              <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                <router-link class="btn btn-outline-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" to="/resume">Resume
                  <i class="bi bi-file-earmark-person-fill"></i></router-link>
                <router-link class="btn btn-outline-secondary btn-lg px-5 py-3 fs-6 fw-bolder" to="/proyects">
                  Projects
          ...
          <div class="col-xxl-7">
            ...
            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
              <div class="profile bg-gradient-primary-to-secondary">
                ...
                <img class="profile-img" src="../assets/image/Profile-Ludwing-Hernandez.png" alt="..." />
                <div class="dots-1">
                  <!-- SVG Dots-->
